...
function page() {
  return (
    <div className="h-full m-5">
      <div className="text-2xl font-semibold">Driver - ABC Enterprise</div>
      ...
      <div className="mt-5 bg-white p-6">
        <div className="flex justify-between ">
          ...
          <Badge className="bg-green-500">99 % Compatible</Badge>
        </div>
        ...
        <div>
          ...
          <div className="flex mt-3 gap-5">
            <div className="bg-[#22C55E] p-4 w-[220px] cursor-pointer  font-bold text-center text-white">
              Agree
            </div>
            <div className="bg-[#F8F8F8] p-4 text-[#FF3B30] cursor-pointer  font-bold w-[220px] text-center">
              Disagree
            </div>
          </div>
